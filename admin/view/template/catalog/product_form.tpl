...
<div id="content">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-line"><?php echo $entry_tag; ?></label>
                <div class="col-sm-10">
                  <select name="input-line" id="input-line" class="form-control">
                    <?php foreach ($lines as $key => $line){ ?>
                    <?php if ($product_description[$lang]['tag'] == $line['title'][$lang]){ $a = 1; ?>
                    <option value="<?php echo $key; ?>" selected<?php foreach ($languages as $language) { ?> data-l<?php echo $language['language_id']; ?>="<?php echo $line['title'][$language['language_id']]; ?>"<?php } ?>><?php echo $line['title'][$lang]; ?></option>
                    <?php }else{ ?>e
                    <option value="<?php echo $key; ?>"<?php foreach ($languages as $language) { ?> data-l<?php echo $language['language_id']; ?>="<?php echo $line['title'][$language['language_id']]; ?>"<?php } ?>><?php echo $line['title'][$lang]; ?></option>
                    <?php } ?>
                    <?php } ?>
                    <?php if (!$a){ ?>
                    <option value="" selected><?php echo $entry_tag; ?></option>
                    <?php }else{ ?>
                    <option value=""><?php echo $entry_tag; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
  ...
  <script>
    $('#input-line').change(function(){
      <?php foreach ($languages as $language) { ?>
        $('#input-tag<?php echo $language['language_id']; ?>').val($('#input-line').find('option[value="'+$(this).val()+'"]').data('l<?php echo $language['language_id']; ?>'));
        <?php } ?>
      });
  </script>
  <script type="text/javascript"><!--
