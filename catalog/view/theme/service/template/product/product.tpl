        ...
        <div class="flex-wrapper product-full-flex-wrapper">
            <div class="flex-item gallery thumbnails">
                <figure class="big-size borders">
                    <a class="thumbnail" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img
                ...
                <div class="flex-wrapper">
                    ...
                    <figure class="small-size ">
                        <div class="borders"><a class="thumbnail" href="<?php echo $image['popup']; ?>"
            ...
            <div class="flex-item all-description">
                <table class="stats">
                    ...
                    <tr>
                        ...
                        <td class="value"><img class="manufacturer-flag" src="http://e-shop//catalog/view/theme/service/image/italy.jpg" alt=""> <?php echo $main_attributes['manufacturer']; ?></td>

                    </tr>
                    <tr>
                        <td class="key">Двигатель:</td>
                        <td class="value"><?php echo $main_attributes['engine']; ?></td>
                    </tr>
                    <tr>
                        <td class="key">Генератор:</td>
                        <td class="value"><?php echo $main_attributes['generator']; ?></td>
                    </tr>
                    <tr>
    ...
    <div class="wide-body-layout">
        <form class="flex-wrapper" action="">
            ...
            <div class="inputs-wrapper flex-wrapper">
                ...
                <?php $i++;?>
                <input type="radio" id="option[<?php echo $option['product_option_id'].$i; ?>]"
                    ...
                    <div class="product-list flex-wrapper">
                        ...
                        <div class="product borders flex-item flex-wrapper">
                            ...
                            <div class="product-footer flex-wrapper">
                                ...
                                <div class="flex-item">
                                    <button class="blue-button callme_viewform"
                                            onclick="addFieldsToPopup(productName = '<?php echo $heading_title; ?>', productUrl = '<?php echo $product["
                                            href
