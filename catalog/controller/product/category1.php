<?php
class ControllerProductCategory1 extends Controller {
    public function index() {
        ...
        if ($category_info) {
            ...
            $data['lnk_prod'] = $this->url->link('product/category1', 'path=' . $this->request->get['path'] . $url .'&lines=0');
            $data['lnk_line'] = $this->url->link('product/category1', 'path=' . $this->request->get['path'] . $url);

            // Set the last category breadcrumb
            $data['breadcrumbs'][] = array(
                'text' => $category_info['name'],
                'href' => $this->url->link('product/category1', 'path=' . $this->request->get['path'])
            );
            ...
            foreach ($results as $result) {
                ...
                $data['categories'][] = array(
                    ...
                    'thumb' => $image,
                    'href'  => $this->url->link('product/category1', 'path=' . $this->request->get['path'] . '_' . $result['category_id'] . $url)
                );
            }
...
//  ------------------------------- Custom filter begin ---------------------------------------------------------
            ...
            $data['sorts'][] = array(
                ...
                'value' => 'p.price-ASC',
                'href'  => $this->url->link('product/category1', 'path=' . $this->request->get['path'] . '&sort=p.price&order=ASC' . $url)
            );

            $data['sorts'][] = array(
                'text'  => $this->language->get('text_price_desc'),
                'value' => 'p.price-DESC',
                'href'  => $this->url->link('product/category1', 'path=' . $this->request->get['path'] . '&sort=p.price&order=DESC' . $url)
            );
            ...
            foreach($limits as $value) {
                $data['limits'][] = array(
                    'text'  => $value,
                    'value' => $value,
                    'href'  => $this->url->link('product/category1', 'path=' . $this->request->get['path'] . $url . '&limit=' . $value)
                );
            }
            ...
            $pagination->url = $this->url->link('product/category1', 'path=' . $this->request->get['path'] . $url . '&page={page}');
            ...
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('product/category1', $url)
            );
