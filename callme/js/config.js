...
var cmeData = {
	...
	'fields' 				: 'Имя (Ваше имя), =Номер телефона (Ваш телефон)*, Email (Ваш email*), Название формы (Название формы), Название товара (Название товара), Ссылка на товар (Ссылка на товар), Вид исполнения (Вид исполнения)',
